    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {DASHBOARD_CARDS.map((card) => (
          <Link
            key={card.href}
            href={card.href}
            className="group flex flex-col rounded-[var(--portal-card-radius)] border border-[hsl(var(--portal-border))] bg-[hsl(var(--portal-card))] p-[var(--portal-card-padding)] transition-all duration-200 hover:border-[hsl(var(--portal-primary))] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[hsl(var(--portal-ring))]"
          >
      ...
      <section>
        ...
        <div className="mt-4 rounded-[var(--portal-card-radius)] border border-dashed border-[hsl(var(--portal-border))] bg-[hsl(var(--portal-muted))]/30 p-8 text-center">
          ...
          <Link
            href="/products"
            className="mt-4 inline-flex items-center justify-center rounded-[var(--portal-button-radius)] bg-[hsl(var(--portal-primary))] px-4 py-2 text-sm font-medium text-[hsl(var(--portal-primary-foreground))] transition-colors hover:bg-[hsl(var(--portal-primary))]/90 focus:outline-none focus:ring-2 focus:ring-[hsl(var(--portal-ring))] focus:ring-offset-2"
          >
            Start Shopping
          </Link>
        </div>
