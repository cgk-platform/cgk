 ...
 *
 * Fetches terms of service from Shopify Shop API when available,
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Terms of service for ${tenantName}.`,
  }
}
...
export default async function TermsOfServicePage() {
  // Try to fetch policy from Shopify
    ...
    <div className="mx-auto max-w-store px-4 py-12">
      <article className="mx-auto max-w-3xl">
        <h1 className="mb-2 text-3xl font-bold tracking-tight text-cgk-navy md:text-4xl">
          {shopifyContent?.title ?? 'Terms of Service'}
        </h1>
