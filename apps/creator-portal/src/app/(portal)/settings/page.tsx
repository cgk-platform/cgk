...
/**
 * Creator Settings Index Page
 *
 * Links to all settings sub-pages: profile, payout methods, brand preferences, notifications, security.
 */
...
const settingsSections = [
  ...
  },
  {
    ...
    description: 'Set your preferences for brand collaborations',
    href: '/settings/brand-preferences',
    icon: Building,
  },
  {
    title: 'Notifications',
