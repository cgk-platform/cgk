...
const QUEUE_TYPE: EmailQueueType = 'esign'
const BASE_PATH = '/admin/communications/queues/esign'
const PAGE_TITLE = 'E-Sign Email Queue'
const PAGE_DESC = 'Monitor e-sign document notification emails'
