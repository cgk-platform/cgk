...
const QUEUE_TYPE: EmailQueueType = 'subscription'
const BASE_PATH = '/admin/communications/queues/subscription'
const PAGE_TITLE = 'Subscription Email Queue'
const PAGE_DESC = 'Monitor subscription lifecycle emails'
