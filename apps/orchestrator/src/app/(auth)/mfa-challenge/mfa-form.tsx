 ...
 * MFA Form Component
 *
 * Client component that handles MFA verification form state and submission.
...
/**
 * Loading skeleton for the MFA form
 */
export function MfaFormSkeleton() {
  return (
    <div className="space-y-6 animate-pulse">
      <div>
        <div className="h-4 w-32 bg-muted rounded mb-2 mx-auto" />
