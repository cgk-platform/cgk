...
export function Footer() {
  return (
    <footer className="w-full bg-[#161f2b]">
      ...
      <div className="flex flex-col items-center justify-center gap-[30px] px-4 py-10 lg:hidden">
        {/* Headline */}
        <div className="flex w-full max-w-[328px] flex-col items-start justify-center gap-[20px]">
          ...
          <p className="font-manrope text-[15px] leading-[1.6] font-medium tracking-[-0.15px] text-white">
            Join our newsletter and get exclusive access to giveaways, discounts, and new releases
          </p>
        </div>

        {/* Form */}
        <div className="flex w-full max-w-[328px] flex-col gap-[10px]">
          <input
            type="email"
      ...
      {/* Logo Section - Mobile */}
      <div className="relative h-[75px] px-4 lg:hidden">
        <div className="absolute bottom-[3px] left-4 h-8 w-[141px]">
          <img
        ...
        <div className="absolute top-0 left-1/2 h-px w-full max-w-[328px] -translate-x-1/2 bg-white/20" />
      </div>

      {/* Navigation & Contact - Mobile Stacked */}
      <div className="flex flex-col gap-[50px] px-4 py-[30px] lg:hidden">
        {/* Shop Column */}
        ...
        <div className="flex w-full flex-col gap-[24px] rounded-[8px] border border-solid border-[#0268a0] px-[16px] py-[20px]">
          <p className="font-manrope text-[13px] leading-[1.15] font-bold tracking-[0.26px] text-white uppercase">
            contact
          </p>
      ...
      <div className="hidden items-start gap-[50px] p-[50px] lg:flex">
      ...
      {/* Bottom Bar */}
      <div className="flex flex-col items-center justify-center gap-5 border-t border-white/10 px-4 pt-[20px] pb-[30px] lg:flex-row lg:justify-between lg:px-[50px]">
        <p className="font-manrope text-center text-[13px] leading-[1.55] tracking-[0.26px] text-white lg:text-left">
