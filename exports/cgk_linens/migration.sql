...
-- Generated: 2026-03-04T04:08:36.184Z
-- Tables: 403 (211 total records)
...
INSERT INTO public.organizations (
  ...
  'eb034004-90c1-427e-ae6b-4091ea8a0cef'::uuid,
  'cgk_linens',
  'CGK Linens',
  '{}'::jsonb,
  NULL,
  ...
  '2026-02-10 23:27:09.49198+00'::timestamptz,
  '2026-02-10 23:27:09.49198+00'::timestamptz
...
-- npx @cgk-platform/cli tenant:create cgk_linens

-- Or create schema manually and run migrations:
-- CREATE SCHEMA IF NOT EXISTS tenant_cgk_linens;
...
-- pg_dump --schema=tenant_cgk_linens --data-only --no-owner --no-privileges \
--   -h SOURCE_HOST -U SOURCE_USER -d SOURCE_DB > cgk_linens_data.sql

-- Import data to target:
-- psql -h TARGET_HOST -U TARGET_USER -d TARGET_DB -f cgk_linens_data.sql
...
-- brand_context_documents                           5 records
-- brand_context_versions                            1 records
