...
-- Generated: 2026-03-04T04:07:33.528Z
-- Tables: 403 (207 total records)
...
INSERT INTO public.organizations (
  ...
  '5cb87b13-3b13-4400-9542-53c8b8d12cb8'::uuid,
  'meliusly',
  'Meliusly',
  ...
  '2026-02-27 21:52:30.196607+00'::timestamptz,
  '2026-03-03 19:10:15.772132+00'::timestamptz
...
-- npx @cgk-platform/cli tenant:create meliusly

-- Or create schema manually and run migrations:
-- CREATE SCHEMA IF NOT EXISTS tenant_meliusly;
...
-- pg_dump --schema=tenant_meliusly --data-only --no-owner --no-privileges \
--   -h SOURCE_HOST -U SOURCE_USER -d SOURCE_DB > meliusly_data.sql

-- Import data to target:
-- psql -h TARGET_HOST -U TARGET_USER -d TARGET_DB -f meliusly_data.sql
...
-- attribution_options                              14 records
...
-- shopify_connections                               1 records
-- shopify_oauth_states                              1 records
...
-- tenant_recovery_settings                          2 records
