...
def main():
    ...
    p_gq.add_argument("--project", required=True, help="Project (bucket) ID")
    ...
    p_lq.add_argument("--project", required=True, help="Project (bucket) ID")
    ...
    p_cq.add_argument("--project", required=True, help="Project (bucket) ID")
    ...
    p_getq.add_argument("--project", required=True, help="Project (bucket) ID")
    ...
    p_la.add_argument("--project", required=True, help="Project (bucket) ID")
    ...
    p_ca.add_argument("--project", required=True, help="Project (bucket) ID")
    ...
    p_ga.add_argument("--project", required=True, help="Project (bucket) ID")
