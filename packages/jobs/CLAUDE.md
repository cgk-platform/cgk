# @cgk-platform/jobs - AI Development Guide
...
```typescript
import { sendJob, sendJobs } from '@cgk-platform/jobs'
...
import type { OrderCreatedPayload, TenantEvent } from '@cgk-platform/jobs'
...
```typescript
import { createJobHandler, withTenantContext } from '@cgk-platform/jobs'
...
import { composeMiddleware, withLogging, withTimeout } from '@cgk-platform/jobs'
...
import { sendJob, SCHEDULES } from '@cgk-platform/jobs'
...
```typescript
import { EVENT_CATEGORIES, TOTAL_EVENT_COUNT } from '@cgk-platform/jobs'
...
| `@cgk-platform/db` | Tenant context (`withTenant`) |
...
### Uses:
- `@cgk-platform/db` - Tenant context
...
```typescript
import { createJobClient, setJobClient } from '@cgk-platform/jobs'
